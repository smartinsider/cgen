...
public:
    ...
    // const std::vector<unsigned char>& CGenDevKey() const { return vCGenDevKey; }
    // const std::vector<unsigned char>& CGenFundKey() const { return vCGenFundKey; }
    ...
    std::string DevPubKey1() const { return strDevpubkey1; }
    std::string DevPubKey2() const { return strDevpubkey2; }
...
protected:
    ...
    // std::vector<unsigned char> vCGenDevKey;
    // std::vector<unsigned char> vCGenFundKey;
    // int nDevFee;
    // int nFundFee;
    int nDefaultPort;
    ...
    std::string strDevpubkey1;
    std::string strDevpubkey2;
