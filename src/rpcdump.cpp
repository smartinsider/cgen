...
UniValue importprivkey(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 3)
        throw runtime_error(
            "importprivkey \"cgenprivkey\" ( \"label\" rescan )\n"
            "\nAdds a private key (as returned by dumpprivkey) to your wallet.\n"
            "\nArguments:\n"
            "1. \"cgenprivkey\"   (string, required) The private key (see dumpprivkey)\n"
...
UniValue dumpprivkey(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "dumpprivkey \"cgenaddress\"\n"
            "\nReveals the private key corresponding to 'cgenaddress'.\n"
            "Then the importprivkey can be used with this output\n"
            "\nArguments:\n"
            "1. \"cgenaddress\"   (string, required) The cgen address for the private key\n"
            "\nResult:\n"
...
UniValue bip38encrypt(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 2)
        throw runtime_error(
            "bip38encrypt \"cgenaddress\"\n"
            "\nEncrypts a private key corresponding to 'cgenaddress'.\n"
            "\nArguments:\n"
            "1. \"cgenaddress\"   (string, required) The cgen address for the private key (you must hold the key already)\n"
