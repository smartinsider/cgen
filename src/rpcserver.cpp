...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* CGen features */
        {"cgen", "masternode", &masternode, true, true, false},
        {"cgen", "listmasternodes", &listmasternodes, true, true, false},
        {"cgen", "getmasternodecount", &getmasternodecount, true, true, false},
        {"cgen", "masternodeconnect", &masternodeconnect, true, true, false},
        {"cgen", "masternodecurrent", &masternodecurrent, true, true, false},
        {"cgen", "masternodedebug", &masternodedebug, true, true, false},
        {"cgen", "startmasternode", &startmasternode, true, true, false},
        {"cgen", "createmasternodekey", &createmasternodekey, true, true, false},
        {"cgen", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"cgen", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"cgen", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"cgen", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"cgen", "getmasternodescores", &getmasternodescores, true, true, false},
        {"cgen", "mnsync", &mnsync, true, true, false},
        {"cgen", "spork", &spork, true, true, false},
        {"cgen", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"cgen", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use cgend, or the -server option to cgen-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> cgen-cli " + methodname + " " + args + "\n";
}
