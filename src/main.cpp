...
CAmount GetBlockValue(int nHeight)
{
    ...
    if ( nHeight == 0 ) {    
      nSubsidy = 0 * COIN;
    } else if (nHeight < 21) { // premine
      nSubsidy = 10000000 * COIN;
    } else if (nHeight > 20 && nHeight < 200) {
      nSubsidy = 0.1 * COIN;
    } else if (nHeight > 199 && nHeight < 20000) {
      nSubsidy = 300 * COIN;
    } else if (nHeight > (20000 - 1) && nHeight < 20000) {
      nSubsidy = 400 * COIN;
    } else if (nHeight > (20000 * 3 - 1) && nHeight < (20000 * 4)) {
      nSubsidy = 500 * COIN;
    } else if (nHeight > (20000 * 5 - 1) && nHeight < (20000 * 6)) {
      nSubsidy = 600 * COIN;
    } else if (nHeight > (20000 * 7 - 1) && nHeight < (20000 * 8)) {
      nSubsidy = 700 * COIN;
    } else if (nHeight > (20000 * 9 - 1) && nHeight < (20000 * 10)) {
      nSubsidy = 800 * COIN;
    } else if (nHeight > (20000 * 11 - 1) && nHeight < (20000 * 12)) {
      nSubsidy = 900 * COIN;
    } else if (nHeight > (20000 * 13 - 1) && nHeight < (20000 * 14)) {
      nSubsidy = 1000 * COIN;
    } else if (nHeight > (20000 * 15 - 1) && nHeight < (20000 * 16)) {
      nSubsidy = 1100 * COIN;
    } else if (nHeight > (20000 * 17 - 1) && nHeight < (20000 * 18)) {
      nSubsidy = 1200 * COIN;
    } else if (nHeight > (20000 * 19 - 1) && nHeight < (20000 * 20)) {
      nSubsidy = 1300 * COIN;
    } else if (nHeight > (20000 * 21 - 1) && nHeight < (20000 * 22)) {
      nSubsidy = 1400 * COIN;
    } else if (nHeight > (20000 * 23 - 1) && nHeight < (20000 * 24)) {
      nSubsidy = 1500 * COIN;
    } else if (nHeight > (20000 * 25 - 1) && nHeight < (20000 * 26)) {
      nSubsidy = 1600 * COIN;
    } else if (nHeight > (20000 * 27 - 1) && nHeight < (20000 * 28)) {
      nSubsidy = 1700 * COIN;
    } else if (nHeight > (20000 * 29 - 1) && nHeight < (20000 * 30)) {
      nSubsidy = 1800 * COIN;
    } else if (nHeight > (20000 * 31 - 1) && nHeight < (20000 * 32)) {
      nSubsidy = 1900 * COIN;
    } else if (nHeight > (20000 * 33 - 1) && nHeight < (20000 * 34)) {
      nSubsidy = 2000 * COIN;
    } else if (nHeight > (20000 * 35 - 1) && nHeight < (20000 * 36)) {
      nSubsidy = 1900 * COIN;
    } else if (nHeight > (20000 * 37 - 1) && nHeight < (20000 * 38)) {
      nSubsidy = 1800 * COIN;
    } else if (nHeight > (20000 * 39 - 1) && nHeight < (20000 * 40)) {
      nSubsidy = 1700 * COIN;
    } else if (nHeight > (20000 * 41 - 1) && nHeight < (20000 * 42)) {
      nSubsidy = 1600 * COIN;
    } else if (nHeight > (20000 * 43 - 1) && nHeight < (20000 * 44)) {
      nSubsidy = 1500 * COIN;
    } else if (nHeight > (20000 * 45 - 1) && nHeight < (20000 * 46)) {
      nSubsidy = 1400 * COIN;
    } else if (nHeight > (20000 * 47 - 1) && nHeight < (20000 * 48)) {
      nSubsidy = 1300 * COIN;
    } else if (nHeight > (20000 * 49 - 1) && nHeight < (20000 * 50)) {
      nSubsidy = 1200 * COIN;
    } else if (nHeight > (20000 * 51 - 1) && nHeight < (20000 * 52)) {
      nSubsidy = 1100 * COIN;
    } else {
      nSubsidy = 1000 * COIN;
    }
...
int64_t GetDevFundPayment1(int nHeight, int64_t blockValue)
{
    int64_t ret_val = 0;
...
int64_t GetDevFundPayment2(int nHeight, int64_t blockValue)
{
    int64_t ret_val = 0;
    ret_val = blockValue * 5 / 100; //5% of the reward while POS
    return ret_val;
