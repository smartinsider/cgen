/* src/config/cgen-config.h.  Generated from cgen-config.h.in by configure.  */
/* src/config/cgen-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef CGen_CONFIG_H

#define CGen_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.cgen.net"

/* Define to the full name of this package. */
#define PACKAGE_NAME "CGen Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "CGen Core 1.0.2"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "cgen"
