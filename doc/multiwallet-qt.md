...
In order to support loading of multiple wallets in cgen-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is cgen.cpp.
...
Changes to cgen.cpp
----------------------
cgen.cpp is the entry point into cgen-qt, and as such, will require some minor modifications to provide hooks for
