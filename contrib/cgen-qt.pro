...
RESOURCES += src/qt/cgen.qrc src/qt/cgen_locale.qrc

TRANSLATIONS += src/qt/locale/cgen_bg.ts \
                src/qt/locale/cgen_de.ts \
                src/qt/locale/cgen_en.ts \
                src/qt/locale/cgen_es.ts \
                src/qt/locale/cgen_fi.ts \
                src/qt/locale/cgen_fr.ts \
                src/qt/locale/cgen_it.ts \
                src/qt/locale/cgen_ja.ts \
                src/qt/locale/cgen_pl.ts \
                src/qt/locale/cgen_pt.ts \
                src/qt/locale/cgen_ru.ts \
                src/qt/locale/cgen_sk.ts \
                src/qt/locale/cgen_sv.ts \
                src/qt/locale/cgen_vi.ts \
                src/qt/locale/cgen_zh_CN.ts \
                src/qt/locale/cgen_zh_TW.ts
