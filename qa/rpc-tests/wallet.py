...
#   c) node1 mines 32 blocks, so now node 0 has 60001cgen, node 1 has 4250cgen, node2 has none.
#   d) node0 sends 601 cgen to node2, in two transactions (301 cgen, then 300 cgen).
